...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/login", "/", "/join", "/healthcheck", "/chat", "/ws/chat", "/kakaologin/callback", "/myroom/chat","/myroom/detail/{postId}/chat",
                                "/others/room/detail/{postId}/chat", "/myroom", "/myroom/addstuff").permitAll()    // 모든 권한 허용
